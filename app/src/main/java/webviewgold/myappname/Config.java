...
public class Config {
    ...
    public static final String PURCHASECODE = "1245-8956-5634-5645-12334";
    // 4. Enjoy your app! :)
    ...
    public static final String HOST = "foodapp1.bellsfood.ng";

    // Your URL including https:// or http:// prefix and including www. or any required subdomain (e.g., "https://www.example.org")
    public static String HOME_URL = "https://foodapp1.bellsfood.ng";
    ...
    public static String HOME_URL_LOGOUT = "https://foodapp1.bellsfood.ng/logout";
